...
namespace FitnessTracker.Api.Data.Migrations
{
    ...
    [Migration("20260907175011_Strava")]
    partial class Strava
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FitnessTracker.Api.Data.AppUser", b =>
                {
            ...
            modelBuilder.Entity("FitnessTracker.Api.Data.FoodEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("FitnessTracker.Api.Data.WeighIn", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("FitnessTracker.Api.Data.StrengthSet", b =>
                {
                    b.HasOne("FitnessTracker.Api.Data.Exercise", null)
                        .WithMany("Sets")
